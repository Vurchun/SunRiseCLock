...
void CMSIS_FullInit(void)
{
    ...
    {
        while (1)
            ; // Помилка пріоритету, зациклюємося
    }
}
...
void RTC_Init(void)
{
    ...
    {
    } // Очікувати, поки LSE не стабілізується
    ...
    {
    } // Очікування готовності режиму ініціалізації
...
char *setActualMenu(int8_t v, int8_t h)
{
    ...
    { // Рухаємося по вертикалі
        ...
        { // Якщо команда ВНИЗ - входу/редагування
    ...
    { // Якщо горизонтальна навігація
        ...
        { // Якщо режим редагування не активний, навігація серед дочірніх елементів одного батька
...
void EXTI2_3_IRQHandler(void)
{
    ...
    if (EXTI->PR & EXTI_PR_PR2)
    {
        ...
        else
        {
            ...
            if (SysTimer_ms - timeIncrementButtonDown > 4 * menu[29].value)
...
void EXTI4_15_IRQHandler(void)
{
    ...
    if (EXTI->PR & EXTI_PR_PR9)
    {
        ...
        { // Якщо сигнал 1 (відновлення сигналу)
